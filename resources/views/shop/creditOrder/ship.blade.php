        ...
        <div class="content-wrapper">
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url('shop/creditOrder')}}">授信订单列表</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group col-lg-12" id="edit-express">
                                {{ Form::open(array('url' => route('creditOrder.edit_express'))) }}
                                {{ csrf_field() }}
                                {{ method_field('POST') }}
                            ...
                            <div class="form-group col-lg-12">
                                {{ Form::open(array('url' => route('creditOrder.update'))) }}
                                {{ csrf_field() }}
                                {{ method_field('POST') }}
