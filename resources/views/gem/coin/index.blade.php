        ...
        <div class="content-wrapper">
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">币增宝</a></li>
                        <li class="breadcrumb-item active" aria-current="page">计划列表</li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">币增宝列表</h4>
                            <br>
                            <a href="{{ route('coin.create') }}" class="btn btn-success">添加</a>
                            <br>
                            <br>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                                <a href="{{ route('coin.edit', $data) }}" class="btn btn-sm btn-gradient-dark btn-icon-text" style="margin-right: 3px;    margin-bottom: 10px;">编辑
